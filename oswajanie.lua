...
oswajanie.food_db = {
    ...
    ["cukinia"] = {typ=WARZYWA, D="cukinii", N="cukinia", r = "cukini(a|e|i)"},
    ...
    ["bolen"]       = {typ=RYBY, D="bolenia",    N="boleniem",       short={"blekitnawa"}, opis = "Ryba posiada wydluzone, nieco bocznie splaszczone cialo o spiczastej glowie i malych oczkach. Otwor gebowy jest szeroki, zuchwa nieco dluzsza z trojkatna wypukloscia, ktora przy zamknieciu pyska wchodzi w zaglebienie szczeki gornej. Jej pokryty malymi, kolistymi luskami grzbiet ma  oliwkowozielona, blekitnie lsniaca barwe, boki sa nieco jasniejsze z zoltawym polyskiem, brzuch srebrzystobialy zas pletwy maja ladna, czerwona barwe."},
